...
describe('JSON Schema', () => {
    ...
    describe('Test schema priority', function () {
        ...
        it('Default snippet with description', () => __awaiter(this, void 0, void 0, function* () {
            ...
            languageService.configure(languageSettingsSetup.languageSettings);
            const testTextDocument = testHelper_1.setupTextDocument('foo:  ');
            const result = yield languageService.doComplete(testTextDocument, vscode_languageserver_1.Position.create(0, 5), false);
