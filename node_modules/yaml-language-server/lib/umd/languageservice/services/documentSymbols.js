    ...
    class YAMLDocumentSymbols {
        ...
        findDocumentSymbols(document, context = { resultLimit: Number.MAX_VALUE }) {
            ...
            try {
                ...
                this.telemetry.sendError('yaml.documentSymbols.error', { error: objects_1.convertErrorToTelemetryMsg(err) });
            }
            return results;
        }
        findHierarchicalDocumentSymbols(document, context = { resultLimit: Number.MAX_VALUE }) {
            ...
            try {
                ...
                this.telemetry.sendError('yaml.hierarchicalDocumentSymbols.error', { error: objects_1.convertErrorToTelemetryMsg(err) });
            }
            return results;
        }
    }
