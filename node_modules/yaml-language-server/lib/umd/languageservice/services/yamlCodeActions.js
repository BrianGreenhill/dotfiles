        ...
        getUnusedAnchorsDelete(diagnostics, document) {
            ...
            for (const diag of diagnostics) {
                if (diag.message.startsWith('Unused anchor') && diag.source === jsonParser07_1.YAML_SOURCE) {
                    ...
                    const action = vscode_languageserver_1.CodeAction.create(`Delete unused anchor: ${actual}`, createWorkspaceEdit(document.uri, [vscode_languageserver_1.TextEdit.del(range)]), vscode_languageserver_1.CodeActionKind.QuickFix);
