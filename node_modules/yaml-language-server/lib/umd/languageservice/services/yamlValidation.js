...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "vscode-languageserver", "vscode-json-languageservice/lib/umd/services/jsonValidation", "../parser/jsonParser07", "../utils/textBuffer", "../parser/yaml-documents", "../utils/objects", "./validation/unused-anchors"], factory);
    }
        ...
        doValidation(textDocument, isKubernetes = false) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    this.telemetry.sendError('yaml.validation.error', objects_1.convertErrorToTelemetryMsg(err));
                }
                let previousErr;
